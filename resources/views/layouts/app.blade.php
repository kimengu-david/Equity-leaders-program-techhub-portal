        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="https://davikani.s3.eu-west-3.amazonaws.com/images/logo/logo.png" />
        ...
        <div id="home" class="landing">
            <div class="home-wrap">
                <div class="home-inner">
                    <img class="img-responsive" src="https://davikani.s3.eu-west-3.amazonaws.com/images/background/bg2.jpg" />
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 partners">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="https://davikani.s3.eu-west-3.amazonaws.com/images/clients/testclient1.png">
                            </div>
                            <div class="col-md-8">
                                <blockquote>
                    ...
                    <div class="col-md-6 partners">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="https://davikani.s3.eu-west-3.amazonaws.com/images/clients/testclient3.jpg">
                            </div>
                            <div class="col-md-8">
                                <blockquote>
